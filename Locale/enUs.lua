...
L["Defaults for Unrecognized Equipment"] = "Defaults for Unrecognized Equipment"
L["Use Default State"] = "Use Default State"
L["This determines the behavior when an item is equipped for the first time. If enabled, visibility will be set to a default. If disabled, visibility will not be changed."] = "This determines the behavior when an item is equipped for the first time. If enabled, visibility will be set to a default. If disabled, visibility will not be changed."
L["This determines the visibility of an item the first time it's equipped"] = "This determines the visibility of an item the first time it's equipped"

L["Forget All Hats"] = "Forget All Hats"
L["Forget All Cloaks"] = "Forget All Cloaks"
